...
public class Ejercicio10_Profe {

	public static void main(String[] args) {
		
			System.out.println(maximoDeTresNumeros(7, 8, 9));
			System.out.println(maximoDeTresNumeros(7, 6, 9));
			
			System.out.println(maximoDeTresNumeros(2,4, 2));
			System.out.println(maximoDeTresNumeros(1,4, 3));
			
			System.out.println(maximoDeTresNumeros(8, 7,6));
			System.out.println(maximoDeTresNumeros(8, 3,7));
